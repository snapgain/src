      ...
      <div className="container mx-auto px-4 py-3">
        <div className="flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center space-x-6">
            <Link to="snapgain.uk/features" className="hover:text-primary transition-colors font-medium">Features</Link>
            <Link to="snapgain.uk/pricing" className="hover:text-primary transition-colors font-medium">Pricing</Link>
            <Link to="snapgain.uk/about" className="hover:text-primary transition-colors font-medium">About Us</Link>
          </nav>
